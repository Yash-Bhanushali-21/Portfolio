...
$(window).on("load", function () {
  ...
  //TypeWriter Section
  setTimeout(function () {
    //this function is triggered after the bove animation
...
function showHide() {
  ...
  if ($(window).scrollTop() < 500) {
    //solivng the home error. since body height:100% is present, automtically last element is selected. thus offset is increased such that it skips first element. Thus this manipulation.
    $("#temp").css("color", "#f4c613");
  } else {
    //after swapping the color once, scrollspy works perfect. Thus removing additional css property.
    $("#temp").css("color", "");
  }
}
